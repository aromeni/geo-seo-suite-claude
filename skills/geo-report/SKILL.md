...
| Brand Authority | 20% | geo-brand-mentions |
| Content Quality & E-E-A-T | 20% | geo-content |
| Technical Foundation | 15% | geo-technical |
| Schema & Structured Data | 10% | geo-schema |
| AI Platform Optimization | 10% | geo-platform-optimizer |

### Score Formula
```
GEO Score = (Citability * 0.25) + (Brand * 0.20) + (Content * 0.20) + (Technical * 0.15) + (Schema * 0.10) + (Platform * 0.10)
```
...
| AI Platform Optimization | XX/100 | 10% | XX |
| **Overall** | | | **XX/100** |
```
